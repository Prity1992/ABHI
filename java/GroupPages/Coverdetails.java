...
public class Coverdetails extends GenericMethods{
	...
	//Click on ADD btn
		...
		private By Save2 = By.xpath("//button[@id='SaveBtn']");
		//Ok
...
//		Base Sum Insured
	...
	//active health 
		...
		//RACV - Road Ambulance Expenses
			...
			private By Addcoverbtn2 = By.xpath("(//button[contains(text(),'Add')])[2]");
			private By Addcoverbtn3 = By.xpath("(//button[contains(text(),'Add')])[3]");
			private By Addcoverbtn5 = By.xpath("(//button[contains(text(),'Add')])[5]");
			
			//closeBtn
			
			private By closeBtn_cover= By.xpath("(//button[contains(text(),'Close')])");
		...
		// Save button on BASE Cover
				...
				private By savebasecoverbtn2 = By.xpath("(//button[contains(text(),'Save')])[2]");
				private By savebasecoverbtn3 = By.xpath("(//button[contains(text(),'Save')])[3]");
				//private By savebasecoverbtn5 = By.xpath("(//button[contains(text(),'Save')])[5]");
		...
		//HLTHRET - HealthReturns TM
				...
				private By HLTHRETEmployerMemberPercentage = By.xpath("//input[@id='Employee %']");
				
				private By HLTHRETEmployeePercentage = By.xpath("//input[@id='Employer %']");
	...
	// MTEX - Maternity Benefit	
	 ...
	 //HSCB - Hospital Cash Benefit
				...
				private By CoverageLimit_HSCB= By.xpath("(//div[@class='col-xs-14']/preceding::input[@id='Cover Limit'])[1]");
				
				private By DeductibleDays_HSCB= By.xpath("(//div[@class='col-xs-14']/preceding::select[@id='Deductible Days'])[1]");
				
				private By LimitsperHospitalizationClaim_HSCB= By.xpath("(//div[@class='col-xs-14']/preceding::select[@id='Limit Per Hospitalization'])[1]");
				
				private By OneYearWaitingPeriod_HSCB= By.xpath("(//div[@class='col-xs-14']/preceding::select[@id='One Year Waiting Period'])[1]");
				
				private By CoverageLimitICU_HSCB= By.xpath("(//div[@class='col-xs-14']/preceding::input[@id='ICU Coverage SI'])[1]");
				
				private By PerPolicyYearLimitinDays_HSCB= By.xpath("(//div[@class='col-xs-14']/preceding::select[@id='Per Policy Year Limit'])[1]");
  ...
  //DPPE - Damage to Personal Protective Equipment
	...
	//OPDE - Out-patient Expenses
				...
				private By OPDEcoverlink1= By.xpath("//a[contains(text(),'OPDE')]");
	...
	//VDH - Virus Detection and Hospitalization
				...
				private By VDHcoverlink= By.xpath("//a[contains(text(),'VDH')]");
	...
	//ERAC - Emergency Road Ambulance Cover
				...
				private By ERACcoverlink1= By.xpath("//a[contains(text(),'ERAC')]");
				
				private By  ERACCoverageLimit = By.xpath("//input[@id='Cover Limit']");
				
	//PRHM - Pre – hospitalization Medical Expenses
				
				private By PRHMcoverlink1= By.xpath("//a[contains(text(),'PRHM')]");
	...
	//IPDCT - In-patient Care with day care treatment
				...
				private By IPDCT_Deductible = By.xpath("//input[@id='Coverage Deductible']");
...
// Gruop Arogya Sanjeevani 
				
				private By StandardCover = By.xpath("//b[contains(text(),'Standard')]");
				
				private By AYUSHCover = By.xpath("//a[contains(text(),'AYSH')]");
				
				private By coverlimit = By.xpath("//input[@id='Cover Limit']");
				
				
				
				private By DCTTCover = By.xpath("//a[contains(text(),'DCTT')]");
				
				private By DCTTcoverlimit = By.xpath("//input[@id='Cover Limit']");
				
				
				
				private By IPTTCover = By.xpath("//a[contains(text(),'IPTT')]");
				
				private By IPTTSumInsured = By.xpath("//select[@id='Applicable Sum Insured']");
				
				
				private By PohmCover = By.xpath("//a[contains(text(),'POHM')]");
				
				private By POHMPeriodDays = By.xpath("//select[@id='Post-hospitalisation Period(Days)']");
				
				
				
				private By PrhmCover = By.xpath("//a[contains(text(),'PRHM')]");
				
				private By PRHMPeriodDays = By.xpath("//select[@id='Pre-hospitalisation Period(Days)']");
				
				
				
				private By RacvCover = By.xpath("//a[contains(text(),'RACV')]");
				
				private By RACVcoverlimit = By.xpath("//input[@id='Cover Limit']");
				...
				// CANCERASS 
						private By CANCERASSCover = By.xpath("//b[contains(text(),'CANCERASS')]");
						
						private By CIPHcoverlink = By.xpath("//a[contains(text(),'CIPH')]");
						
						private By  CIPHSI = By.xpath("//input[@id='Applicable Suminsured']");
						
						private By CIPHRoomcategary = By.xpath("//select[@id='Room Category1']");
						
						
					//// DCTT-Daycare Treatment	
						private By DCTTcovelink = By.xpath("//a[contains(text(),'DCTT')]");
						
						private By  DCTTSI = By.xpath("//input[@id='Applicable Suminsured']");
						
					// //ERAC - Emergency Road Ambulance	
						private By ERACcoverlink = By.xpath("//a[contains(text(),'ERAC')]");
						
						private By  limitperhospitalization = By.xpath("//input[@id='Cover Limit']");
						
					// FUCPT - Follow-Up care Post Treatment
						
						private By FUCPTcoverlink = By.xpath("//a[contains(text(),'FUCPT')]");	
						
						private By FUCPTSI = By.xpath("//input[@id='Applicable Suminsured']");
						
					// OPDE1 - Cancer Out-Patient Treatment
						
						private By OPDE1coverlink = By.xpath("//a[contains(text(),'OPDE1')]");	
						
						private By OPDE1SI = By.xpath("//input[@id='Applicable Suminsured']");
						
					// POHM - Post-Hospitalisation	
						
						
						private By POHMSI = By.xpath("//input[@id='Applicable Suminsured']");
						
					// PRHM - Pre-Hospitalisation		
						
						private By PRHMcoverlink = By.xpath("//a[contains(text(),'PRHM')]");
						
						private By PRHMSI = By.xpath("//input[@id='Applicable Suminsured']");
						
					// CREDITPRO - Credit Protect	
						
						private By CREDITPROCover = By.xpath("//b[contains(text(),'CREDITPRO')]");
						
						private By CPcoverlink = By.xpath("//a[contains(text(),'CP')]");
						
						private By CPSI = By.xpath("//input[@id='Cover Limit']");
						
						private By BenefitOption = By.xpath("//select[@id='Credit Benefit Option']");
						
						
				// HEARTASS - Heart Assure Cover	
						
						private By HEARTASSCover = By.xpath("//b[contains(text(),'HEARTASS')]");
						
						private By POHM2coverlink = By.xpath("//a[contains(text(),'POHM2')]");
						
						private By PostHospitalisationDays = By.xpath("//input[@id='Post Hospitalization Period in Days']");
						
						
						
						private By PRHM2coverlink = By.xpath("//a[contains(text(),'PRHM2')]");
						
						private By PreHospitalisationDays = By.xpath("//input[@id='Post Hospitalization Period in Days']");
						
						
						
						private By CIIPHCardiacIndemnitycoverlink = By.xpath("//a[contains(text(),'CIIPH')]");
						
						private By CIIPHSI = By.xpath("//input[@id='Applicable Suminsured']");
						
						
						private By optiondropdown = By.xpath("//input[@id='Cardiac Option']");
						
						
						private By ERAC1coverlink = By.xpath("//a[contains(text(),'ERAC1')]");
						
						
						private By CoverageLimitperhospitalization = By.xpath("//input[@id='Cover Limit']");
						
				// OPD - OPD Cover		
						
						private By OPDOPDCover = By.xpath("//b[contains(text(),'OPD - OPD')]");
						
						private By OPDEcoverlink = By.xpath("//a[contains(text(),'OPDE')]");
						
						
			// HEARTSEC - Heart Secure Cover
						
						private By HEARTSECCover = By.xpath("//b[contains(text(),'HEARTSE')]");	
						
						private By HSCHeartSecureCoverlink = By.xpath("//a[contains(text(),'HSC')]");
						
						private By HSCSI = By.xpath("//input[@id='Applicable Suminsured']");
						
						private By NumberofConditionsCovered = By.xpath("//select[@id='Number of Conditions Covered']");
						
			// HOSPCASH - Hospital Cash Benefit			
						
						private By HOSPCASHCover = By.xpath("//b[contains(text(),'HOSPCASH')]");
						
						
						private By HOSPCASHCoverlink = By.xpath("//a[contains(text(),'HSCB')]");
						
						
						private By coveragelimitperday = By.xpath("//select[@id='Coverage Limit Per Day']");
						
						private By deuctabledays = By.xpath("//select[@id='Deductible Days1']");
						
						
						
						
			// CANCERSEC - Cancer Secure			
						
						
						private By CANCERSECCover = By.xpath("//b[contains(text(),'CANCERSEC')]");
						
						private By csCoverlink = By.xpath("//a[contains(text(),'HSCB')]");
						
						
						private By CSCCoverlink = By.xpath("//a[contains(text(),'CSC')]");
						
						private By CSCcoverageoption = By.xpath("//select[@id='Number of Session']");
						
						private By CSCSI = By.xpath("//input[@id='Applicable Suminsured']");
						
						private By SurvivalPeriod = By.xpath("//select[@id='Cancer Survival Period']");
						
						private By PayoutOptions = By.xpath("//select[@id='Cancer Payout Option']");
						
						
						
						private By pcCoverlink = By.xpath("//a[contains(text(),'PC')]");
						
						private By pcSI = By.xpath("//select[@id='Applicable Suminsured']");
						
				// INCOMEP - Income Protect		
						
						private By INCOMEPCCover = By.xpath("//b[contains(text(),'INCOMEP')]");
						
						private By IPCoverlink = By.xpath("//a[contains(text(),'IP')]");
						
						
						private By MonthlyCoverageLimit = By.xpath("//input[@id='Cover Limit']");
						
						
						private By PeriodofPayment = By.xpath("//select[@id='Period of Payment']");
						
						
						private By InitialWaitingPeriod = By.xpath("//select[@id='Income Waiting Period']");
						
						private By HEARTSEC= By.xpath("//b[contains(text(),'HEARTSEC')]");						
						
						private By HEARTSECcoverlink= By.xpath("//a[contains(text(),'HSC')]");
						
						private By HEARTSEC_SumInsured = By.xpath("//input[@id='Applicable Suminsured']");
	 ...
	 //Group Activ Health (4211) || Group Activ Health V2 (5211) Covers
			...
			public  void fillEmployeeDetailsGroup_active_healthPage (WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
			   
			  {
				...
				if(dataRow.getProperty("Product").equalsIgnoreCase("Group Activ Health (4211)"))
				{
				   if(dataRow.getProperty("BASE-Base").equalsIgnoreCase("Yes"))
					{
					   click(BaseCover, "Base cover");
					   
					   java.util.List<WebElement> list = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[2]/preceding::div[@id='CoverOptional']/ol/div"));
					...
					if(dataRow.getProperty("POHM").equalsIgnoreCase("Yes"))
					{
						...
						selectFromDropdownByVisibleText(Posthospitalizationdropdown, dataRow.getProperty("POHM-Post hospitalization")," BNBE SumInsured ");
						Thread.sleep(WaitTime.low);
					}
...
//						clearAndSenKeys(IPTTSI,dataRow.getProperty("IPTTSI"),"DCHS SI");
						...
						selectFromDropdownByVisibleText(CoverageOptiondropdown, dataRow.getProperty("IPTT-CoverageOptiondropdown"),"Coverage Option dropdown");
						Thread.sleep(WaitTime.low);
						
						if(!dataRow.getProperty("IPTT-CoverageOptiondropdown").equalsIgnoreCase("Room Type"))
						{
						selectFromDropdownByVisibleText(ICUCoveragedropdown, dataRow.getProperty("IPTT-ICUCover"),"IPTT-ICUCover");
						Thread.sleep(WaitTime.low);
						}
						
						selectFromDropdownByVisibleText(roomtypedropdown, dataRow.getProperty("IPTT-Roomtype"),"IPTT-Roomtype");
						Thread.sleep(WaitTime.low);
					}
...
//						
					...
					// Save button
					//click(savebasecoverbtn2,"Save btn");
					...
					click(OKBtn,"OK");
		 			...
		 			//click(closeBtn_cover, "Close BTN");
			...
			// Optional Cover
				   if(dataRow.getProperty("OPTIONAL-Optional").equalsIgnoreCase("Yes"))
					{
				   
					click(optionalCover, "optional cover");
					
				java.util.List<WebElement> optionalCover_list = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[3]/preceding::div[@id='CoverOptional']/ol/div"));
...
*/					}
			...
			selectFromDropdownByVisibleText(healthReturnsLimit,dataRow.getProperty("HealthReturns TM Limit"),"HealthReturns TM Limit");
			Thread.sleep(WaitTime.low);
			selectFromDropdownByVisibleText(earnedBenefitsSplit,dataRow.getProperty("HLTHRET-Earned Benefits Split"),"Earned Benefits Split");
			Thread.sleep(WaitTime.low);
			
			selectFromDropdownByVisibleText(healthReturnUtilizationPeriod,dataRow.getProperty("Health Return Utilization Period"),"Health Return Utilization Period");
			Thread.sleep(WaitTime.low);
		//	clearAndSenKeys(HLTHRETEmployerMemberPercentage,dataRow.getProperty("HLTHRET- EmployerMemberPercentage"),"HLTHRET- EmployerMemberPercentage");
			Thread.sleep(WaitTime.low);
		//	clearAndSenKeys(HLTHRETEmployeePercentage,dataRow.getProperty("HLTHRET-EmployeePercentage"),"HLTHRET-EmployeePercentage");
			Thread.sleep(WaitTime.low);
				...
				selectFromDropdownByVisibleText(membereligibility,dataRow.getProperty("HLTHA-MemberEligibility"),"Member Eligibility");
				Thread.sleep(WaitTime.low);
				...
				selectFromDropdownByVisibleText(checkuplimit,dataRow.getProperty("HLTCH-checkuplimit"),"check up limit");
				Thread.sleep(WaitTime.low);
				...
				selectFromDropdownByVisibleText(frequencyperyear,dataRow.getProperty("FTAS-FrequencyPerYear"),"Frequency per Policy Year");
				Thread.sleep(WaitTime.low);
				
				selectFromDropdownByVisibleText(noOfassenssmentPerSession,dataRow.getProperty("FTAS-NoofAssessments"),"No Of Asenssement per session");
				Thread.sleep(WaitTime.low);
				}
				...
				click(savebasecoverbtn2,"Save btn");
				//click(savebasecoverbtn3,"Save btn");
				Thread.sleep(WaitTime.low);
				...
				// Standalone Cover
				   ...
				   if(dataRow.getProperty("STANDALONE").equalsIgnoreCase("Yes"))
					{
						click(standaloneCover, "standalone cover");
						Thread.sleep(WaitTime.low);
							
						java.util.List<WebElement> standalone_list = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[4]/preceding::div[@id='CoverOptional']/ol/div"));
			...
			if(dataRow.getProperty("Product").equalsIgnoreCase("Group Activ Health V2 (5211)"))
			{
				if(dataRow.getProperty("BASE-Base").equalsIgnoreCase("Yes"))
				{
				   click(BaseCover, "Base cover");
...
*/					}
	...
	//	clearAndSenKeys(HLTHRETEmployeePercentage,dataRow.getProperty("HLTHRET-EmployeePercentage"),"HLTHRET-EmployeePercentage");
	  ...
	  public  void fillEmployeeDetailsGroup_active_SecurePage (WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
	    {
		  String sheetName = ConfigReader.getInstance().getValue(PropertyConfigs.TestSheet);
	       Properties dataRow = ExcelRead.readRowDataInProperties(workbook, sheetName, testCaseName,stepGroup);
		 ...
		 //Click on HC - Hospita Cash Cover
		   ...
		   if(dataRow.getProperty("HospitalCashCover").equalsIgnoreCase("Yes"))
			{
			...
			for(int a=0;a<=HospitalCashCover_list.size();a++)
			{
				...
				selectFromDropdownByVisibleText(OneYearWaitingPeriod_AHCB,dataRow.getProperty("One Year Waiting Period_AHCB"),"One Year Waiting Period");
				Thread.sleep(WaitTime.low);
				...
				selectFromDropdownByVisibleText(OneYearWaitingPeriod_HSCB,dataRow.getProperty("One Year Waiting Period_HSCB"),"One Year Waiting Period");
				Thread.sleep(WaitTime.low);
		   ...
		   if(dataRow.getProperty("PersonalAccidentCover").equalsIgnoreCase("Yes"))
			{
		   ...
		   if(dataRow.getProperty("CriticalIllnessCover").equalsIgnoreCase("Yes"))
			{
		   ...
		   click(closeBtn_cover,"Close Button");
			Thread.sleep(WaitTime.low);
				
				
	}
	
	  public  void fillEmployeeDetailsGroup_AssureCovid19Page (WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
	    {
		  String sheetName = ConfigReader.getInstance().getValue(PropertyConfigs.TestSheet);
	       Properties dataRow = ExcelRead.readRowDataInProperties(workbook, sheetName, testCaseName,stepGroup);
	    ...
	    //VIRUSD - Virus Detection
		   if(dataRow.getProperty("VIRUSD(VirusDetection)").equalsIgnoreCase("Yes"))
			...
			for(int a=0;a<VirusDetectionCover_list.size();a++)
			{
				...
				if(!dataRow.getProperty("VDHApplicability").equalsIgnoreCase("Null"))
				{
				selectFromDropdownByVisibleText(VDHApplicability,dataRow.getProperty("VDHApplicability"),"Applicability");
				Thread.sleep(WaitTime.low);
				}
				if(!dataRow.getProperty("VDHSumInsured").equalsIgnoreCase("Null"))
				{
				...
				if(!dataRow.getProperty("VDPOApplicability").equalsIgnoreCase("Null"))
				{
				selectFromDropdownByVisibleText(VDPOApplicability,dataRow.getProperty("VDPOApplicability"),"Applicability");
				Thread.sleep(WaitTime.low);
				}
				
				if(!dataRow.getProperty("VDPOSumInsured").equalsIgnoreCase("Null"))
				{
			...
			for(int a=0;a<OptionalCoverageCover_list.size();a++)
			{
				...
				String txtnm=driver.findElement(By.xpath("(//button[contains(text(),'Add')])[2]/preceding::div[@id='CoverOptional']/ol/div["+count+"]")).getText();
				...
				if(!dataRow.getProperty("RTSumInsured").equalsIgnoreCase("Null"))
				{
				selectFromDropdownByVisibleText(RTSumInsured,dataRow.getProperty("RTSumInsured"),"Sum Insured");
				Thread.sleep(WaitTime.low);
				}
				if(!dataRow.getProperty("RTApplicability").equalsIgnoreCase("Null"))
				{
	    ...
	    //HOSP - Hospitalization
			...
			for(int a=0;a<HospitalizationCover_list.size();a++)
			{
				...
				//String txtnm=driver.findElement(By.xpath("(//button[contains(text(),'Add')])[3]/preceding::div[@id='CoverOptional']/ol/div["+count+"]")).getText();
...
//				count=count/count;
			...
			if(dataRow.getProperty("ERAC").equalsIgnoreCase("Yes"))
			{
							...
							if(!dataRow.getProperty("ERAC(CoverageLimit)").equalsIgnoreCase("Null"))
							{
			...
			if(dataRow.getProperty("PRHM").equalsIgnoreCase("Yes"))
			{
							...
							if(!dataRow.getProperty("PRHM(Pre-Hospitalization Period)").equalsIgnoreCase("Null"))
							{
			...
			if(dataRow.getProperty("POHM").equalsIgnoreCase("Yes"))
			{
							...
							if(!dataRow.getProperty("POHM(Post-HospitalizationPeriod)").equalsIgnoreCase("Null"))
							{
		...
		
	  {
		  String sheetName = ConfigReader.getInstance().getValue(PropertyConfigs.TestSheet);
		   ...
		   Reporter.log("<B>Traverse To Group_active_TravelPage</B>");
			...
			//MEDICALCVR - Medical Cover(Mandotory Cover-IPDCT)
		   ...
		   if(dataRow.getProperty("MEDICALCVR").equalsIgnoreCase("Yes"))
			...
			for(int a=0;a<MEDICALCVRCoverlist.size();a++)
			{
				...
				clearAndSenKeys(IPDCT_Deductible,dataRow.getProperty("IPDCT_Deductible"),"Automatic Extension Limit");
				//Thread.sleep(WaitTime.low)
...
//				String txtnm=driver.findElement(By.xpath("(//button[contains(text(),'Add')])[1]/preceding::div[@id='CoverOptional']/ol/div["+count+"]")).getText();
			...
			//Add Covers
			click(Addcoverbtn,"ADD Button");
			boolean okBTNIPTT1 = getSize(By.xpath("//button[contains(text(),'OK')]"),"Button") !=0;
			if (okBTNIPTT1 == true) 
			{
				click(OKBtn,"OK");
			}
			...
			if(dataRow.getProperty("RCC").equalsIgnoreCase("Yes"))
			{
				  ...
				  clearAndSenKeys(RCC_SumInsured,dataRow.getProperty("RCC_SumInsured"),"Sum Insured"); Thread.sleep(WaitTime.low);
			...
			if(dataRow.getProperty("PMC").equalsIgnoreCase("Yes"))
			{
				  ...
				  clearAndSenKeys(PMC_SumInsured,dataRow.getProperty("TMNDOT_SumInsured"),"Sum Insured"); Thread.sleep(WaitTime.low);
...
//					String txtnm=(OETOMCVRCoverlist.get(a)).getText();
	  ...
	  public  void fillEmployeeDetailsGroup_protect_Page (WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
	  {
			String sheetName = ConfigReader.getInstance().getValue(PropertyConfigs.TestSheet);
			Properties dataRow1 = ExcelRead.readRowDataInProperties(workbook, sheetName, testCaseName,stepGroup);
			Reporter.log("<B>Traverse To Group_active_SecurePage</B>");

			if(dataRow1.getProperty("CANCERASSCover").equalsIgnoreCase("Yes"))
			{

				click(CANCERASSCover, "CANCERASSCover");

				java.util.List<WebElement> cancerASSCover_list = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[1]/preceding::div[@id='CoverOptional']/ol/div"));

				for(int a=0;a<cancerASSCover_list.size();a++)
				{
					int b =a+2;
					String txtnm=(cancerASSCover_list.get(a)).getText();


					//	CIPH-Cancer In-Patient Hospitalisation

					if(dataRow1.getProperty("CIPH-Cancer In-Patient Hospitalisation").equalsIgnoreCase("Yes"))
					{

						if(txtnm.contains("CIPH"))
						...
						click(CIPHcoverlink,"HLTHRET coverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(CIPHSI,dataRow1.getProperty("CIPHSI"),"CIPHSI");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);

						selectFromDropdownByVisibleText(CIPHRoomcategary,dataRow1.getProperty("CIPH Room Categary"),"Health Return Utilization Period");
						Thread.sleep(WaitTime.low);
					...
					if(dataRow1.getProperty("DCTT-Daycare Treatment").equalsIgnoreCase("Yes"))
					{
						...
						click(DCTTcovelink,"DCTT coverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(DCTTSI,dataRow1.getProperty("DCTTSI"),"DCTTSI");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);
					...
					if(dataRow1.getProperty("ERAC - Emergency Road Ambulance").equalsIgnoreCase("Yes"))
					{
						...
						click(ERACcoverlink,"DCTT coverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(limitperhospitalization,dataRow1.getProperty("ERAC Cover Limit"),"ERAC Cover Limit");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);
					...
					// FUCPT - Follow-Up care Post Treatment
					if(dataRow1.getProperty("FUCPT - Follow-Up care Post Treatment").equalsIgnoreCase("Yes"))
					{

						if(txtnm.contains("FUCPT"))
						...
						click(FUCPTcoverlink,"DCTT coverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(FUCPTSI,dataRow1.getProperty("FUCPTSI"),"FUCPTSI");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);
					...
					if(dataRow1.getProperty("OPDE1 - Cancer Out-Patient Treatment").equalsIgnoreCase("Yes"))
					{

						if(txtnm.contains("OPDE1"))
						...
						click(OPDE1coverlink,"DCTT coverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(OPDE1SI,dataRow1.getProperty("OPDE1SI"),"OPDE1SI");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);
					...
					if(dataRow1.getProperty("POHM - Post-Hospitalisation").equalsIgnoreCase("Yes"))
					{
						...
						clearAndSenKeys(POHMSI,dataRow1.getProperty("POHMSI"),"POHMSI");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);
					...
					// PRHM - Pre-Hospitalisation	
					if(dataRow1.getProperty("PRHM - Pre-Hospitalisation").equalsIgnoreCase("Yes"))
					{
						...
						click(PRHMcoverlink,"DCTT coverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(PRHMSI,dataRow1.getProperty("PRHMSI"),"PRHMSI");
						Thread.sleep(WaitTime.low);
						Thread.sleep(WaitTime.low);
			...
			// CREDITPRO - Credit Protect COVER		
			
			if(dataRow1.getProperty("CREDITPROCover").equalsIgnoreCase("Yes"))
			{

			click(CREDITPROCover, "CREDITPRO Cover");

			// CP - Credit Protect	

			if(dataRow1.getProperty("CP - Credit Protect").equalsIgnoreCase("Yes"))
			{

				driver.findElement(By.xpath("//span[contains(text(),'Cover Groups')]//following::input[3]")).click();
				click(Addcoverbtn,"ADD Button");
				boolean okBTNIPTT = getSize(By.xpath("//button[contains(text(),'OK')]"),"Button") !=0;
				if (okBTNIPTT == true) 
				{
				...
				click(CPcoverlink,"CP coverlink");
				Thread.sleep(WaitTime.low);

				clearAndSenKeys(CPSI,dataRow1.getProperty("CPSI"),"CPSI");
				Thread.sleep(WaitTime.low);

				selectFromDropdownByVisibleText(BenefitOption,dataRow1.getProperty("BenefitOption"),"BenefitOption");
				Thread.sleep(WaitTime.low);
			...
			if(dataRow1.getProperty("HEARTASSCover").equalsIgnoreCase("Yes"))
			{

			click(HEARTASSCover, "HEARTASS Cover");

			java.util.List<WebElement> HEARTASSCover = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[3]/preceding::div[@id='CoverOptional']/ol/div"));

			for(int i=0;i<HEARTASSCover.size();i++)
			{
				int j =i+2;
				String str=(HEARTASSCover.get(i)).getText();

				// POHM2 - Post-Hospitalisation	

				if(dataRow1.getProperty("POHM2 - Post-Hospitalisation").equalsIgnoreCase("Yes"))
				{

					if(str.contains("POHM2"))

					{

						driver.findElement(By.xpath("//span[contains(text(),'Cover Groups')]//following::input["+j+"]")).click();
						click(Addcoverbtn,"ADD Button");
						boolean okBTNIPTT = getSize(By.xpath("//button[contains(text(),'OK')]"),"Button") !=0;
						if (okBTNIPTT == true) 
						{
					...
					click(POHM2coverlink,"DCTT coverlink");
					Thread.sleep(WaitTime.low);

					clearAndSenKeys(PostHospitalisationDays,dataRow1.getProperty("Post Hospitalisation Days"),"PostHospitalisationDays");
					Thread.sleep(WaitTime.low);
				...
				if(dataRow1.getProperty("PRHM2 -Pre-Hospitalisation").equalsIgnoreCase("Yes"))
				{

					if(str.contains("PRHM2"))
					...
					click(PRHM2coverlink,"DCTT coverlink");
					Thread.sleep(WaitTime.low);

					clearAndSenKeys(PreHospitalisationDays,dataRow1.getProperty("Pre Hospitalisation Days"),"Pre HospitalisationDays");
					Thread.sleep(WaitTime.low);
					Thread.sleep(WaitTime.low);
				...
				if(dataRow1.getProperty("CIIPH - Cardiac Indemnity In-patient Hospitalization").equalsIgnoreCase("Yes"))
				{

					if(str.contains("CIIPH"))
					...
					click(CIIPHCardiacIndemnitycoverlink,"CIIPH CardiacIndemnity coverlink");
					Thread.sleep(WaitTime.low);

					clearAndSenKeys(CIIPHSI,dataRow1.getProperty("CIIPHSI"),"CIIPHSI");
					Thread.sleep(WaitTime.low);

					selectFromDropdownByVisibleText(optiondropdown,dataRow1.getProperty("option dropdown"),"optiondropdown");
					Thread.sleep(WaitTime.low);
					Thread.sleep(WaitTime.low);
				...
				if(dataRow1.getProperty("ERAC1 - Emergency Ambulance").equalsIgnoreCase("Yes"))
				{

					if(str.contains("ERAC1"))
					...
					click(ERAC1coverlink,"CIIPH CardiacIndemnity coverlink");
					Thread.sleep(WaitTime.low);

					clearAndSenKeys(CoverageLimitperhospitalization,dataRow1.getProperty("CoverageLimitperhospitalization"),"CIIPHSI");
					Thread.sleep(WaitTime.low);
			...
			if(dataRow1.getProperty("OPDOPDCover").equalsIgnoreCase("Yes"))

			{

				click(OPDOPDCover, "OPDOPDCover Cover");

				java.util.List<WebElement> OPDOPDCover = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[4]/preceding::div[@id='CoverOptional']/ol/div"));

				for(int i=0;i<=OPDOPDCover.size();i++)
				{
					int j =i+2;
					String str=(OPDOPDCover.get(i)).getText();

					// POHM2 - Post-Hospitalisation	

					if(dataRow1.getProperty("OPDE - OPD Expenses").equalsIgnoreCase("Yes"))
					{

						if(str.contains("OPDE"))
						...
						click(OPDEcoverlink,"DCTT coverlink");
						Thread.sleep(WaitTime.low);
			...
			click(HEARTSECCover, "HEARTSECCover Cover");

			java.util.List<WebElement> HEARTSECCover = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[5]/preceding::div[@id='CoverOptional']/ol/div"));

			for(int i=0;i<HEARTSECCover.size();i++)
			{
				int j =i+6;
				String str=(HEARTSECCover.get(i)).getText();

				// POHM2 - Post-Hospitalisation	

				if(dataRow1.getProperty("HSC - Heart Secure Cover").equalsIgnoreCase("Yes"))
				{
...

					{
						...
						WebElement Ele=	driver.findElement(By.xpath("//span[contains(text(),'Cover Groups')]//following::input["+j+"]"));
						try
						{
							Ele.click();
						}
						catch(Exception e) {}
						click(Addcoverbtn5,"ADD Button");
						boolean okBTNIPTT = getSize(By.xpath("//button[contains(text(),'OK')]"),"Button") !=0;
						if (okBTNIPTT == true) 
						{
							click(OKBtn,"OK");
					...
					click(HSCHeartSecureCoverlink,"HSCHeartSecure Coverlinkk");
					Thread.sleep(WaitTime.low);

					clearAndSenKeys(HSCSI,dataRow1.getProperty("HSCSI"),"HSCSI");
					Thread.sleep(WaitTime.low);

					selectFromDropdownByVisibleText(NumberofConditionsCovered,dataRow1.getProperty("NumberofConditionsCovered"),"Number of Conditions Covered");
					Thread.sleep(WaitTime.low);
					
					click(savebasecoverbtn5,"Save btn");
					Thread.sleep(WaitTime.low);
			...
			// HOSPCASH - Hospital Cash Benefit	  
			if(dataRow1.getProperty("HOSPCASHCover").equalsIgnoreCase("Yes"))
			{

				click(HOSPCASHCover, "HEARTSECCover Cover");

				java.util.List<WebElement> HOSPCASHCover = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[5]/preceding::div[@id='CoverOptional']/ol/div"));

				for(int i=0;i<=HOSPCASHCover.size();i++)
				{
					int j =i+2;
					String str=(HOSPCASHCover.get(i)).getText();

					// POHM2 - Post-Hospitalisation	

					if(dataRow1.getProperty("HOSPCASH").equalsIgnoreCase("Yes"))
					{

						if(str.contains("HOSPCASH"))
						...
						click(HOSPCASHCoverlink,"HOSPCASH Coverlink");
						Thread.sleep(WaitTime.low);

						selectFromDropdownByVisibleText(coveragelimitperday,dataRow1.getProperty("coverage limit per day"),"coveragelimitperday");							
						Thread.sleep(WaitTime.low);


						selectFromDropdownByVisibleText(deuctabledays,dataRow1.getProperty("Deuctable days"),"deuctabledays");							
						Thread.sleep(WaitTime.low);
			...
			// CANCERSEC - Cancer Secure	
			if(dataRow1.getProperty("CANCERSECCover").equalsIgnoreCase("Yes"))
			{

				click(CANCERSECCover, "HEARTSECCover Cover");

				java.util.List<WebElement> CANCERSECCover = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[6]/preceding::div[@id='CoverOptional']/ol/div"));

				for(int i=0;i<=CANCERSECCover.size();i++)
				{
					int j =i+2;
					String str=(CANCERSECCover.get(i)).getText();

					// POHM2 - Post-Hospitalisation	

					if(dataRow1.getProperty("CS - Counselling Sessions").equalsIgnoreCase("Yes"))
					{
						...
						click(csCoverlink,"cs Coverlinkk");
						Thread.sleep(WaitTime.low);
					...
					if(dataRow1.getProperty("CSC - Cancer Secure Cover").equalsIgnoreCase("Yes"))
					{
						...
						click(CSCCoverlink,"CSC Coverlink");
						Thread.sleep(WaitTime.low);


						selectFromDropdownByVisibleText(CSCcoverageoption,dataRow1.getProperty("CSC coverageoption"),"CSCcoverageoption");							
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(CSCSI,dataRow1.getProperty("CSCSI"),"CSCSI");							
						Thread.sleep(WaitTime.low);

						selectFromDropdownByVisibleText(SurvivalPeriod,dataRow1.getProperty("Survival Period"),"SurvivalPeriod");							
						Thread.sleep(WaitTime.low);


						selectFromDropdownByVisibleText(PayoutOptions,dataRow1.getProperty("Payout Options"),"PayoutOptions");							
						Thread.sleep(WaitTime.low);
					...
					if(dataRow1.getProperty("PC - Palliative Care").equalsIgnoreCase("Yes"))
					{
						...
						click(pcCoverlink,"pcCoverlink");
						Thread.sleep(WaitTime.low);


						selectFromDropdownByVisibleText(pcSI,dataRow1.getProperty("pcSI"),"pcSI");							
						Thread.sleep(WaitTime.low);
			...
			if(dataRow1.getProperty("INCOMEPCCover").equalsIgnoreCase("Yes"))
			{
				click(INCOMEPCCover, "INCOMEPCCover Cover");

				java.util.List<WebElement> INCOMEPCCover = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[6]/preceding::div[@id='CoverOptional']/ol/div"));

				for(int i=0;i<=INCOMEPCCover.size();i++)
				{
					int j =i+2;
					String str=(INCOMEPCCover.get(i)).getText();



					if(dataRow1.getProperty("IP - Income Protect").equalsIgnoreCase("Yes"))
					{
						...
						click(IPCoverlink,"IPCoverlink");
						Thread.sleep(WaitTime.low);

						clearAndSenKeys(MonthlyCoverageLimit,dataRow1.getProperty("Monthly Coverage Limit"),"Monthly Coverage Limit");							
						Thread.sleep(WaitTime.low);

						selectFromDropdownByVisibleText(PeriodofPayment,dataRow1.getProperty("Periodof Payment"),"Periodof Payment");							
						Thread.sleep(WaitTime.low);


						selectFromDropdownByVisibleText(InitialWaitingPeriod,dataRow1.getProperty("Initial Waiting Period"),"Initial Waiting Period");							
						Thread.sleep(WaitTime.low);
	  ...
	  public  void ffillEmployeeDetailsGroup_protectv2_Page(WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
	    {
		  String sheetName = ConfigReader.getInstance().getValue(PropertyConfigs.TestSheet);
	       Properties dataRow = ExcelRead.readRowDataInProperties(workbook, sheetName, testCaseName,stepGroup);
		   Reporter.log("<B>Traverse To Group_active_SecurePage</B>");
		   ...
		   //HEARTSEC - Heart Secure Cover
		   click(HEARTSEC, "HEARTSEC - Heart Secure Cover");
		   
		   java.util.List<WebElement>HEARTSECCoverlist = driver.findElements(By.xpath("(//button[contains(text(),'Add')])[5]/preceding::div[@id='CoverOptional']/ol/div"));
		   {
			   
			for(int a=0;a<HEARTSECCoverlist.size();a++)
			{
				int b =a+6;
				String txtnm=(HEARTSECCoverlist.get(a)).getText();   
		   
				if(txtnm.contains("HSC"))
				{
				if(dataRow.getProperty("HSC").equalsIgnoreCase("Yes"))
				{
				...
				click(HEARTSECcoverlink,"HEARTSEC - Heart Secure Cover");
				Thread.sleep(WaitTime.low);
				
				
				clearAndSenKeys(HEARTSEC_SumInsured,dataRow.getProperty("HEARTSEC_Sum Insured"),"Sum Insured");
				Thread.sleep(WaitTime.low);
	  ...
	  public  void fillEmployeeDetailsGroup_Arogya_SanajeevaniPage(WebDriver driver,String testCaseName, XSSFWorkbook workbook,Connection conn,String stepGroup,CustomAssert customAssert) throws Exception
		
	  {
		  String sheetName = ConfigReader.getInstance().getValue(PropertyConfigs.TestSheet);
	       Properties dataRow2 = ExcelRead.readRowDataInProperties(workbook, sheetName, testCaseName,stepGroup);
		   Reporter.log("<B>Traverse To Group_Arogya_SanajeevaniPage</B>");
		   
		   click(StandardCover, "Standard Cover");
		  
		  
				
			//	AYSH-AYUSH
				
				if(dataRow2.getProperty("AYSH-AYUSH").equalsIgnoreCase("Yes"))
				{
						
				
				 	click(AYUSHCover,"AYUSHCover");
					Thread.sleep(WaitTime.low);
					
					clearAndSenKeys(coverlimit,dataRow2.getProperty("CoverLimit-AYSH-AYUSH"),"CoverLimit-AYSH-AYUSH");
					Thread.sleep(WaitTime.low);
					Thread.sleep(WaitTime.low);
				...
				if(dataRow2.getProperty("DCTT-DayCareTreatment").equalsIgnoreCase("Yes"))
				{
						
				
				 	click(DCTTCover,"DCTTCover");
					Thread.sleep(WaitTime.low);
					
					clearAndSenKeys(DCTTcoverlimit,dataRow2.getProperty("CoverLimit-DCTT"),"CoverLimit-DCTT");
					Thread.sleep(WaitTime.low);
				...
				if(dataRow2.getProperty("IPTT-HospitalisationExpenses").equalsIgnoreCase("Yes"))
				{
						
				
				 	click(IPTTCover,"IPTTCover");
					Thread.sleep(WaitTime.low);
					
					selectFromDropdownByVisibleText(IPTTSumInsured,dataRow2.getProperty("SumInsured-IPTT"),"SumInsured-IPTT");
					Thread.sleep(WaitTime.low);
				...
				if(dataRow2.getProperty("POHM-Post-HospitalisationExpenses").equalsIgnoreCase("Yes"))
				{
						
				
				 	click(PohmCover,"PohmCover");
					Thread.sleep(WaitTime.low);
					
//					selectFromDropdownByVisibleText(POHMPeriodDays,dataRow2.getProperty("Post-HospitalizationPeriodinDays"),"Post-Hospitalization Period in Days");
//					Thread.sleep(WaitTime.low);
				...
				if(dataRow2.getProperty("PRHM-Pre-HospitalisationExpenses").equalsIgnoreCase("Yes"))
				{
						
				
				 	click(PrhmCover,"PrhmCover");
					Thread.sleep(WaitTime.low);
					
//					selectFromDropdownByVisibleText(PRHMPeriodDays,dataRow2.getProperty("Pre-HospitalizationPeriodinDays"),"Pre-Hospitalization Period in Days");
//					Thread.sleep(WaitTime.low);
//					
					click(savebasecoverbtn,"Save btn");
					Thread.sleep(WaitTime.low);
				...
				if(dataRow2.getProperty("RACV-RoadAmbulanceCover").equalsIgnoreCase("Yes"))
				{
						
				
				 	click(RacvCover,"PrhmCover");
					Thread.sleep(WaitTime.low);
					
					clearAndSenKeys(RACVcoverlimit,dataRow2.getProperty("CoverageLimit-RACVs"),"CoverageLimit-RACV");
					Thread.sleep(WaitTime.low);
